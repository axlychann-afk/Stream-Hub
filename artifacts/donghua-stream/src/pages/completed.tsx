import { useGetCompleted } from "@workspace/api-client-react";
...
export default function Completed() {
  ...
  const { data, isLoading, isFetching } = useGetCompleted(
    { page },
  ...
  return (
    <div className="container mx-auto px-4 pt-24 pb-12 min-h-screen">
      <Helmet>
        <title>Completed Donghua | DonghuaStream</title>
      </Helmet>
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-2 text-lg">Binge-watch fully finished donghua series.</p>
      </div>
