...
import { ChevronLeft, ChevronRight, AlertTriangle, RefreshCw, ListVideo, Server } from "lucide-react";
...
export default function Watch() {
  ...
  // Reset server selection when episode changes
  useEffect(() => {
    setSelectedServer(0);
          ...
          <div className="flex-1 w-full min-w-0 relative group">
            ...
            <div className="bg-card/90 border-t border-border p-3 flex flex-row items-center justify-between gap-3 min-w-0">
              <div className="flex-1 min-w-0 overflow-hidden">
                <h1 className="text-base md:text-lg font-bold text-white truncate leading-tight" title={stream?.title || currentEpInfo?.title}>
